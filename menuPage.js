...
function moleAdjustment(diff) {
    switch(diff.id) {
        case 'easy':
            menuHoleTwo.innerHTML = `<img class="menuMole" src="models/mole.png"/>`;
            menuHoleThree.innerHTML = `<img class="menuGolden" src="models/goldenMole.png"/>`;
            break;
        case 'medium':
            menuHoleTwo.innerHTML = `<img class="menuSpike" src="models/spikeMole.png"/>`;
            menuHoleThree.innerHTML = `<img class="menuGolden" src="models/goldenMole.png"/>`;
            break;
        case 'hard':
            menuHoleTwo.innerHTML = `<img class="menuSpike" src="models/spikeMole.png"/>`;
            menuHoleThree.innerHTML = `<img class="menuSpike" src="models/spikeMole.png"/>`;
            break;
    }
}
